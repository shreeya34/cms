...
public class modules {
       public void insertUpdateDeletemodules(char operation, Integer id, String module_name, String c_name)
           {
        ...
        { 
            try 
               {
                   ps = con.prepareStatement("INSERT INTO module(name,cname) VALUES (?,?)");
